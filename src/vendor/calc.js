/* @smogon/calc v0.11.0 (MIT) — vendored bundle. Do not edit by hand; regenerate with scripts/build-vendor.sh */
(() => {
    ...
    "node_modules/@smogon/calc/dist/field.js"(exports) {
      ...
      var Field2 = (function() {
        function Field3(field) {
          ...
          this.attackerSide = new Side2(field.attackerSide || {});
          this.defenderSide = new Side2(field.defenderSide || {});
        }
      ...
      var Side2 = (function() {
        ...
        Side3.prototype.clone = function() {
